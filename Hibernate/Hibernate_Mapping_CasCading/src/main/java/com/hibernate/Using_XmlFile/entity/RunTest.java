...
//		Create object
		Customer1 c1=new Customer1("Chandan");
		
		Orders1 o1=new Orders1(101);
		Orders1 o2=new Orders1(102);
		Orders1 o3=new Orders1(103);
		
		
//		Make a list of object due to many
		List<Orders1> os1=new ArrayList<Orders1>();
		os1.add(o1);
		os1.add(o2);
		os1.add(o3);
