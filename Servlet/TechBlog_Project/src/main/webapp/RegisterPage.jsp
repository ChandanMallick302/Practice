			...
			<div class="row">
				<div class="col-md-6 offset-md-3">
					<div class="card shadow p-0 mb-2 bg-body-tertiary rounded">
						<div class="card-header fs-3 bg-primary text-white text-center">
							<i class="fa fa-2x fa-user-plus"></i> <br>Register Here
						</div>
						<div class="card-body">
							...
							<form id="reg-form" action="RegisterServlet" method="post">
								<div class="mb-3">
									<label for="user_name" class="form-label">User Name</label> <input
										...
										aria-describedby="userHelp" placeholder="Enter Name" name="name">
								</div>
