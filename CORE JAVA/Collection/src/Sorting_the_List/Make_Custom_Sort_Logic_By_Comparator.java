...
class nameComparator implements Comparator<Employee2> {
	...
	@Override
	public int compare(Employee2 o2, Employee2 o1) {
		// TODO Auto-generated method stub
...
public class Make_Custom_Sort_Logic_By_Comparator {
	...
	public static void main(String[] args) {
		...
		// sorting data by phone
		Collections.sort(emp1, new phoneComparator());

		System.out.println(emp1);

		// sorting by name in descending order (only change o2, o1 in comparator)
